    ...
    case PLUGIN_WEBFORM_LOAD:
      {
        ...
        addFormSelector(F("Mode"), F("plugin_162_mode"), 2 , options0, optionValues0, choice0);
        ...
        addFormSelector(F("Oversample Ratio"), F("plugin_162_osr"), 8 , options1, optionValues1, choice1);
        success = true;
        break;
      }
    ...
    case PLUGIN_INIT:
      {
        ...
        if (checkDeviceID162()) { 
          addLog(LOG_LEVEL_INFO, F("MPL3115A2 : Found"));
        } else {
          addLog(LOG_LEVEL_INFO, F("MPL3115A2 : Not Found"));
        }
